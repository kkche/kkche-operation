...
%s:
  ...
  volumes:
    - '/mnt/acs_mnt/ossfs/kanche-config/workspace/dev-kanche-config-service.conf:/opt/docker/conf/application.conf:rw'

""" % (service_name, image_name, node, nodes, domain_name)
